...
public class UniversalMethod {
    ...
    private static int rxCSearchID; 
    private static int rxSearchID=0; 
    
    public static void setRxSearchID(int id){
        rxSearchID = id;
    }
    public static int getRxSearchID(){
       return rxSearchID;
    }
    public static void setRxCSearchID(int id){
        rxCSearchID = id;
    }
    public static int getRxCSearchID(){
       return rxCSearchID;
    }
  ...
  public void imageMethod(JLabel bgImagela, JLabel uerla2) {
        UniversalMethod u = new UniversalMethod();
         u.imageMethod("/img/2147.jpg", bgImagela);
      //   u.imageMethod("/img/124.jpg", bgImagela);
